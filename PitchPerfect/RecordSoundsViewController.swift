...
class RecordSoundsViewController: UIViewController, AVAudioRecorderDelegate {
    ...
    func audioRecorderDidFinishRecording(_ recorder: AVAudioRecorder, successfully flag: Bool) {
        if flag {
            ...
            let alert = UIAlertController(title: "Recording Unsucessful", message: "Recording was not successul. Try again.", preferredStyle: .alert)
    ...
    func setRecordingState(_ enabled: Bool) {
